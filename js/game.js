...
function createScene() {
  ...
  // audioLoader.load( 'music/bensound-theelevatorbossanova.mp3', function( buffer ) {
...
function loop(){
  ...
  if (!paused){
    ...
    if (propellerForward) {
        ...
        propellerSpeed = Math.max(0, propellerSpeed-0.7);
        airplane.propeller.rotation.x = propellerSpeed;
    ...
    //airplane.propeller.rotation.x +=.2 + game.planeSpeed;
    //console.log(airplane.propeller.rotation.x);
...
function updateEnergy(){
  ...
  game.energy -= game.speed*deltaTime;
...
//https://javascript.info/keyboard-events
   ...
   switch(keyEvent.key) {
     case "p":
        ...
        break;
     case "ArrowLeft":
        propellerForward = false;
        planeSpeed = Math.max(0, planeSpeed-0.7);
        break;
      case "ArrowRight":
        planeSpeed += .7;
        propellerForward = true;
        break;
      case " ":
        propellerForward = false;
        propellerSpeed = 0;
